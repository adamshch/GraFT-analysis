function coef_vals = group_rwLCA_wrapper(dictionary_n, x_im, opts)

% coef_vals = group_rwLCA_wrapper(dictionary_n, x_im, opts)
% 
...
%     opts.groups: Group structure of coefficients (same as for groupLCA)
% 
...
coef_vals = rwLCA(x_im, dictionary_n, 1, opts.eta, opts.gamma_val, floor(1./opts.tol), opts.groups)
